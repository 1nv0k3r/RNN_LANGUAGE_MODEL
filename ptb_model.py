# -*- coding: utf-8 -*-
"""
Created on Sat Apr 28 15:06:32 2018
...
NUM_LAYER = 2                  #LSTM layers
VOCAB_SIZE = 10000              #vocabulary list size
TRAIN_BATCH_SIZE = 20
TRAIN_NUM_STEP = 35
...
MAX_GRAD_NORM = 5               #The maximum of gradient to prevent from gradient explosion
SHARE_EMB_AND_SOFTMAX = True    #Share variables between emb and softmax
...
class PTBModel(object):
    def __init__(self,is_training, batch_size, num_steps):
        ...
        #define rnn structure with LSTM cell
        dropout_keep_prob = LSTM_KEEP_PROB if is_training else 1.0
        lstm_cells = [tf.nn.rnn_cell.DropoutWrapper(tf.nn.rnn_cell.BasicLSTMCell(HIDDEN_SIZE), output_keep_prob=dropout_keep_prob) for _ in range(NUM_LAYER)]
        ...
        #define output list and collect them to the softmax
        outputs = []
        ...
        #define entropy loss function and mean cost
